# How to serialize and deserialize the appointment color using JSON in the .NET MAUI Scheduler

This repository contains the sample code to serialize and deserialize the appointment color using JSON in the [SfScheduler](https://help.syncfusion.com/maui/scheduler/getting-started).

## Syncfusion controls

This project used the following Syncfusion control(s):
* [.NET MAUI DataForm (SfScheduler)](https://www.syncfusion.com/maui-controls/maui-scheduler)
